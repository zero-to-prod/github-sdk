 ...
 */
class UpdateRepoBranchProtectionRequestRequiredPullRequestReviews
{
    use DataModel;
    ...
    public ?UpdateRepoBranchProtectionRequestRequiredPullRequestReviewsDismissalRestrictions $dismissal_restrictions = null;
    ...
    #[Describe(['nullable' => true])]
    public ?UpdateRepoBranchProtectionRequestRequiredPullRequestReviewsBypassPullRequestAllowances $bypass_pull_request_allowances = null;
}
