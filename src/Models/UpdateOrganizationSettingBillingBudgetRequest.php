 ...
 */
class UpdateOrganizationSettingBillingBudgetRequest
{
    use DataModel;
    ...
    #[Describe(['nullable' => true])]
    public ?UpdateOrganizationSettingBillingBudgetRequestBudgetAlerting $budget_alerting = null;

    /** @see $budget_scope */
    public const budget_scope = 'budget_scope';
    #[Describe(['nullable' => true])]
    public ?UpdateOrganizationSettingBillingBudgetRequestBudgetScope $budget_scope = null;
