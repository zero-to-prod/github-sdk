 ...
 */
class UpdateRepoBranchProtectionRequiredPullRequestReviewRequest
{
    use DataModel;
    ...
    public ?UpdateRepoBranchProtectionRequiredPullRequestReviewRequestDismissalRestrictions $dismissal_restrictions = null;
    ...
    #[Describe(['nullable' => true])]
    public ?UpdateRepoBranchProtectionRequiredPullRequestReviewRequestBypassPullRequestAllowances $bypass_pull_request_allowances = null;
}
