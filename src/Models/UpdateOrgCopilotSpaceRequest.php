 ...
 */
class UpdateOrgCopilotSpaceRequest
{
    use DataModel;
    ...
    #[Describe(['nullable' => true])]
    public ?CopilotSpaceBaseRole $base_role = null;

    /** @see $resources_attributes */
    public const resources_attributes = 'resources_attributes';
    /** @var array<int, UpdateOrgCopilotSpaceRequestResourcesAttributesItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => UpdateOrgCopilotSpaceRequestResourcesAttributesItem::class,
        'default' => [],
    ])]
