 ...
 */
class GetAgentRepoTaskResponse
{
    use DataModel;
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentRepoTaskResponseCreatorVariant1 $creator = null;
    ...
    /** @var array<int, GetAgentRepoTaskResponseUserCollaboratorsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => GetAgentRepoTaskResponseUserCollaboratorsItem::class,
        'default' => [],
    ])]
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentRepoTaskResponseOwner $owner = null;

    /** @see $repository */
    public const repository = 'repository';
    #[Describe(['nullable' => true])]
    public ?GetAgentRepoTaskResponseRepository $repository = null;
    ...
    /** @var array<int, GetAgentRepoTaskResponseArtifactsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => GetAgentRepoTaskResponseArtifactsItem::class,
        'default' => [],
    ])]
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentRepoTaskResponseCustomAgent $custom_agent = null;

    /** @see $sessions */
    public const sessions = 'sessions';
    /** @var array<int, GetAgentRepoTaskResponseSessionsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => GetAgentRepoTaskResponseSessionsItem::class,
        'default' => [],
    ])]
