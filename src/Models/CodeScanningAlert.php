...
class CodeScanningAlert
{
    ...
    #[Describe(['nullable' => true])]
    public ?CodeScanningAlertRule $rule = null;
    ...
    /** @see $linked_pull_requests */
    public const linked_pull_requests = 'linked_pull_requests';
    /** @var array<int, PullRequestSimple> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => PullRequestSimple::class,
        'default' => [],
    ])]
    public array $linked_pull_requests;
}
