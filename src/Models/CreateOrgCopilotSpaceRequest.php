 ...
 */
class CreateOrgCopilotSpaceRequest
{
    use DataModel;
    ...
    /** @var array<int, CreateOrgCopilotSpaceRequestResourcesAttributesItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => CreateOrgCopilotSpaceRequestResourcesAttributesItem::class,
        'default' => [],
    ])]
