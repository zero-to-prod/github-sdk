...
class GetAgentTaskResponse
{
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseCreatorVariant1 $creator = null;
    ...
    /** @var array<int, GetAgentTaskResponseUserCollaboratorsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => GetAgentTaskResponseUserCollaboratorsItem::class,
        'default' => [],
    ])]
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseOwner $owner = null;

    /** @see $repository */
    public const repository = 'repository';
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseRepository $repository = null;
    ...
    /** @var array<int, GetAgentTaskResponseArtifactsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => GetAgentTaskResponseArtifactsItem::class,
        'default' => [],
    ])]
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseCustomAgent $custom_agent = null;

    /** @see $sessions */
    public const sessions = 'sessions';
    /** @var array<int, GetAgentTaskResponseSessionsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => GetAgentTaskResponseSessionsItem::class,
        'default' => [],
    ])]
