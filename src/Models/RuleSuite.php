...
class RuleSuite
{
    ...
    /** @see $rule_evaluations */
    public const rule_evaluations = 'rule_evaluations';
    /** @var array<int, RuleSuiteRuleEvaluationsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => RuleSuiteRuleEvaluationsItem::class,
        'default' => [],
    ])]
    public array $rule_evaluations;
}
