 ...
 */
class CreateEnterpriseCodeSecurityConfigurationRequest
{
    use DataModel;
    ...
    #[Describe(['nullable' => true])]
    public ?CreateEnterpriseCodeSecurityConfigurationRequestDependencyGraphAutosubmitActionOptions $dependency_graph_autosubmit_action_options = null;
