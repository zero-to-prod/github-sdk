 ...
 */
class CreateOrgArtifactMetadataDeploymentRecordClusterJobRequest
{
    use DataModel;
    ...
    /** @var array<int, CreateOrgArtifactMetadataDeploymentRecordClusterJobRequestDeploymentsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => CreateOrgArtifactMetadataDeploymentRecordClusterJobRequestDeploymentsItem::class,
        'default' => [],
    ])]
