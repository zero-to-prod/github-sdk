 ...
 */
class ListAgentTasksResponseTasksItem
{
    use DataModel;
    ...
    #[Describe(['nullable' => true])]
    public ?ListAgentTasksResponseTasksItemCreatorVariant1 $creator = null;
    ...
    /** @var array<int, ListAgentTasksResponseTasksItemUserCollaboratorsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => ListAgentTasksResponseTasksItemUserCollaboratorsItem::class,
        'default' => [],
    ])]
    ...
    #[Describe(['nullable' => true])]
    public ?ListAgentTasksResponseTasksItemOwner $owner = null;

    /** @see $repository */
    public const repository = 'repository';
    #[Describe(['nullable' => true])]
    public ?ListAgentTasksResponseTasksItemRepository $repository = null;
    ...
    /** @var array<int, ListAgentTasksResponseTasksItemArtifactsItem> */
    #[Describe([
        'cast' => [self::class, 'mapOf'],
        'type' => ListAgentTasksResponseTasksItemArtifactsItem::class,
        'default' => [],
    ])]
    ...
    #[Describe(['nullable' => true])]
    public ?ListAgentTasksResponseTasksItemCustomAgent $custom_agent = null;
}
