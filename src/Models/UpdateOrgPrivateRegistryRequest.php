 ...
 */
class UpdateOrgPrivateRegistryRequest
{
    use DataModel;
    ...
    public ?OrgPrivateRegistryConfigurationRegistryType $registry_type = null;
    ...
    #[Describe(['nullable' => true])]
    public ?OrganizationActionsSecretVisibility $visibility = null;
