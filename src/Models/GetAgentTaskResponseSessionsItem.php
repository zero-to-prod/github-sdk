 ...
 */
class GetAgentTaskResponseSessionsItem
{
    use DataModel;
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseSessionsItemUser $user = null;

    /** @see $owner */
    public const owner = 'owner';
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseSessionsItemOwner $owner = null;

    /** @see $repository */
    public const repository = 'repository';
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseSessionsItemRepository $repository = null;
    ...
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseSessionsItemUsage $usage = null;

    /** @see $error */
    public const error = 'error';
    #[Describe(['nullable' => true])]
    public ?GetAgentTaskResponseSessionsItemError $error = null;
}
